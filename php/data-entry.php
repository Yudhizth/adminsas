                            ...
                            <div class="form-group">
                                <div id="fixedTime">
                                    <table class="table table-hover table-resposive">
                                        ...
                                        <tr>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_minggu_start" id="mingguMasuk" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_senin_start"  id="seninMasuk" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_selasa_start"  id="selasaMasuk" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_rabu_start"  id="rabuMasuk" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_kamis_start"  id="kamisMasuk" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_jumat_start"  id="jumatMasuk" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_sabtu_start"  id="sabtuMasuk" placeholder="HH">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_minggu_end"  id="mingguKeluar" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_senin_end" id="seninKeluar"  placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_selasa_end"  id="selasaKeluar" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_rabu_end"  id="rabuKeluar" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_kamis_end" id="kamisKeluar" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_jumat_end" id="jumatKeluar" placeholder="HH">
                                            </td>
                                            <td width="14.2%">
                                                <input type="text" class="form-control" name="txt_sabtu_end"  id="sabtuKeluar" placeholder="HH">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
