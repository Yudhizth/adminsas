...
//    $new_kode = implode($new_kode);
    ...
    $sql = "UPDATE tb_login_perusahaan SET password = :pass, kode_password = :now WHERE kd_perusahaan = :perusahaan ";
...
$cek = new Perusahaan();
  ...
  INNER JOIN tb_login_perusahaan ON tb_login_perusahaan.kd_perusahaan=tb_perusahaan.kode_perusahaan
  WHERE kode_perusahaan = :id";
            ...
            <div class="x_content">
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="profile-tab" role="tab" data-toggle="tab" aria-expanded="true">Pofile Perusahaan</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="password-tab" data-toggle="tab" aria-expanded="false">Change Password</a>
                        </li>
                    </ul>
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="profile-tab">
                            <form class="form-horizontal form-label-left" method="post" action="">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Bergabung Sejak <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="txt_dateeeee" value="<?php echo $row['create_date']; ?>" type="text" readonly>
                                    </div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade " id="tab_content2" aria-labelledby="password-tab">
                            <form class="form-horizontal form-label-left" method="post" action="">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="txt_nama" value="<?php echo $row['kode_password']; ?>" type="text" readonly>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="PASSWORD" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="txt_password" type="password" required>
                                    </div>
                                </div>
                                <div class="ln_solid"></div>
                                <div class="form-group">
