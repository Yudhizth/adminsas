...
$tglStart = date('d M Y', strtotime($data['kontrak_start']));
$tglEnd  = date('d M Y', strtotime($data['kontrak_end']));
...
LEFT JOIN tb_list_perkerjaan_perusahaan ON tb_list_perkerjaan_perusahaan.name_list = tb_list_karyawan.kode_pekerjaan
                                                        ...
                                                        <?php if($typeRequest == 'MPO'){
                                                            ...
                                                            while($col = $cek->fetch(PDO::FETCH_LAZY)){ ?>
                                                                <tr>
                                                                    ...
                                                                    <td>Rp. <?=number_format($col['gaji'], 0, ',','.')?></td>
                                                                </tr>
                                                            <?php }
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="project_detail" id="dataKontrak">
                                ...
                                <?php } }else{ ?>
                                    <p>
                                        <button class="btn btn-xs btn-primary generateInvoice" data-kontrak="<?=$id?>">GENERATE INVOICE</button>
                                    </p>
